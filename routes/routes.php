...
$route->get('ultimasVendasRealizadas/{quantidade}', 'PdvDiferencialController@ultimasVendasRealizadas');
$route->get('pdvDiferencial/gerarCupomFiscal/{idVenda?}', 'PdvDiferencialController@gerarCupomFiscal');
$route->get('pdvDiferencial/associarClienteAVenda/{idCliente}', 'PdvDiferencialController@associarClienteAVenda');
...
$route->get('pdvDiferencial/parcelamentoDeCartao',
    'PdvDiferencialController@parcelamentoDeCartao');
