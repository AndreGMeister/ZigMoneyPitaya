...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="card card-stats">
            <div class="card-body">
                <center>
                    Vendas por mês em <?php echo date('Y');?>.
                    <small style="opacity:0.70">Mêses que tiveram vendas</small>
                </center>
                <canvas class="grafico" id="grafico-vendas-por-mes" width="400" height="185"></canvas>
            </div>
            <div class="card-footer ">
                <hr>
                <!--<div class="stats">
                ...
                <?php if (count($totalVendasPorUsuariosNoMes) > 0): ?>
                    <table class="table tabela-ajustada vendas_por_vendedores table-striped">
                        ...
                        <tr class="tr-header-vendas-por-usuarios">
                            <th><i class="fas fa-users" style="font-size:18px;opacity:0.70"></i></th>
                            <th><img src="<?php echo BASEURL;?>/public/img/money-bag.png" alt="" width="20" class="meio-pagamento-icons">  Total</th>
                            <th><img src="<?php echo BASEURL;?>/public/img/money.png" alt="" width="20" class="meio-pagamento-icons"> Dinheiro</th>
                            <th><img src="<?php echo BASEURL;?>/public/img/credit-card.png" alt="" width="20" class="meio-pagamento-icons"> Crédito</th>
                            ...
                            <tr>
                                <td title="<?php echo $produto->nome; ?>">
                                    <?php if (!is_null($produto->imagem) && $produto->imagem != ''): ?>
                                        <img class="imagem-perfil" src="<?php echo $produto->imagem; ?>">
                                    <?php else: ?>
...
<script>
    ...
    ////////////////////////////////////////////////////////
    var ctx = document.getElementById("grafico-vendas-por-mes");
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: [
                <?php foreach ($vendasPorMesNoAno as $mes):?>
                <?php echo "\"{$mes->periodo}\",";?>
                <?php endforeach?>
            ],
            datasets: [{
                label: 'Valor Vendido',
