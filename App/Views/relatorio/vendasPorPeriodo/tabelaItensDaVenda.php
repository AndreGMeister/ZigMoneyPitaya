...
<div id="imprimir">
    <div style="margin-bottom:20px descricao-venda">
        ...
        <?php if ($detalhesDePagamentoItensDaVenda->id_meio_pagamento == 2 && $detalhesDePagamentoItensDaVenda->quantidade_parcela != 0):?>
            <span class="span-badge">
                Parcela: R$
                <?php
                if ($detalhesDePagamentoItensDaVenda->id_meio_pagamento == 2 && $detalhesDePagamentoItensDaVenda->quantidade_parcela == 0) {
                    echo '1x de ' . ' R$ '.real($detalhesDePagamentoItensDaVenda->total);
                } elseif ($detalhesDePagamentoItensDaVenda->id_meio_pagamento == 2) {
                    echo $detalhesDePagamentoItensDaVenda->quantidade_parcela . 'x de ' . 'R$ '.real($detalhesDePagamentoItensDaVenda->valor_parcela);
                }
                ?>
            <?php endif?>
        </span>
